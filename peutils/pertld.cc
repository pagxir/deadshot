...
static int pe_dlmmap(Obj_Entry * obj, PEImage * image, const IMAGE_NT_HEADERS * hdr_pe, const void * hdr_buf, size_t hdr_size)
{
	size_t imgsize;
	ssize_t nbytes;
