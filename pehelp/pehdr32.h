...
extern "C" void * __stdcall GetProcAddress(HINSTANCE, const char *name);
extern "C" void * __stdcall GetModuleHandle(const char *name);
extern "C" void * __stdcall LoadLibrary(const char *name);
